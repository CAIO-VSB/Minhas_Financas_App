...
CREATE TABLE movements (
    ...
    description_transaction VARCHAR(45) NOT NULL,
...
COMMENT ON COLUMN movements.type_transaction IS 'Despesa | Receita';
...
COMMENT ON COLUMN movements.observation IS 'Observação da transação';
