...
export const accountsRepository = {
    ...
    async create(userId: string, data: TAccount) {
        ...
        if (data.initial_balance && data.initial_balance > 0) {
            ...
            const valuesMovements = [userId, 'saldo inicial', data.initial_balance, new Date(), 'saldo inicial', 40, accountsId, null, null, 'Lançamento de saldo inicial', false]
    ...
    async update(userId: string, data: TAccount, id: number) {
        ...
        if (data.initial_balance !== undefined) {
            ...
            const valuesMovements = [userId, 'saldo inicial', data.initial_balance, new Date(), 'saldo inicial', 40, accountsId, null, null, 'saldo inicial', false]
